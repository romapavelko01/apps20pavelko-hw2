...
public interface ImmutableList {
    ...
    ImmutableList add(int index, Object e); //додає елемент
    // до колекції за індексом, та кидає виключну ситуацію,
    // якщо індекс виходить за межі колекції

    ImmutableList addAll(Object[] c); //додає масив
    // елементів у кінець колекції

    ImmutableList addAll(int index, Object[] c); // додає масив
    // елементів починаючи з зазначеного індекса, та кидає
    ...
    // елементу за індексом, та кидає виключну ситуацію,
    // якщо індекс виходить за межі колекції

    int indexOf(Object e); //шукає індекс елемента
    // (повертає індекс першого який знайшов,
    ...
    boolean isEmpty(); //якщо у колеції нема елементів,
    // то повертає true
